...
<div class="kopsurat">
	...
	$_GET['tahun_ajaran']; 
	$_GET['bulan']; 
	$spp = $konek -> query("SELECT tb_tagihan_spp.*,tb_siswa.*,tb_kelas.* FROM tb_tagihan_spp JOIN tb_siswa ON tb_tagihan_spp.nis=tb_siswa.nis 
                            JOIN tb_kelas ON tb_siswa.kd_kelas=tb_kelas.kd_kelas
							WHERE tb_tagihan_spp.ket IS NULL AND tb_siswa.kd_kelas='$_GET[kd_kelas]' AND tb_tagihan_spp.tahun_ajaran='$_GET[tahun_ajaran]' OR tb_tagihan_spp.bulan='$_GET[bulan]'ORDER BY tb_siswa.nis ASC");
	$i=1;
	$total = 0;
	...
	<tr>
		...
		<td align="center"><?php echo"BELUM DIBAYAR";?></td>
	</tr>
	<?php $i++; ?>
...
<?php endwhile; ?>
<tr>
		<td colspan="6" align="center"><b>TOTAL TAGIHAN</b></td>
