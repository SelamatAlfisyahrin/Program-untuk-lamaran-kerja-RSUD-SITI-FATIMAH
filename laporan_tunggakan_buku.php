...
<div class="kopsurat">
	...
	<h3>LAPORAN TUNGGAKAN PEMBAYARAN BUKU</h3>
    ...
    JOIN tb_kelas ON tb_siswa.kd_kelas=tb_kelas.kd_kelas JOIN tb_buku ON tb_tagihan_buku.kd_buku=tb_buku.kd_buku WHERE tb_tagihan_buku.ket IS NULL AND tb_siswa.kd_kelas='$_GET[kd_kelas]' ORDER BY tb_siswa.nis ASC");
	$i=1;
	$total = 0;
