...
<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          ...
          <li class=""><a href="index_operator.php">HOME</i></a></li>
            <li class=""><a href="operator.php">OPERATOR</a></li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="data_kelas.php">INFORMASI KELAS</a></li>	
				        <li><a href="data_angkatan.php">INFORMASI ANGKATAN</a></li>
                <li><a href="data_siswa.php">INFORMASI SISWA</a></li>
              </ul>
            </li>
